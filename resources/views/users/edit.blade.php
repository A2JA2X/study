        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url("users/{$user->id}") }}">
                ...
                <div class="form-group">
                    ...
                    @else
                        <input type="text" class="form-control" id="InputName" name="name" placeholder="Enter your name" value="{{ old('name', $user->name) }}">
                    @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    @else
                        <input type="email" class="form-control" id="InputEmail" name="email" placeholder="Enter your email" value="{{ old('email', $user->email) }}">
                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                    @endif
                </div>
